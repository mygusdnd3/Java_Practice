...
public class ChatClient01 extends JFrame {
	...
	public ChatClient01() {
		...
		try {
			...
			// 이 라인을 실행한다는 것은 작업에 문제가 생긴 경우이므로
		...
		// 이제 통신할 준비가 끝난 상태이다.
		// 데이터를 받을 준비를 한다.
		ClientTrd01 t = new ClientTrd01(this); //New Born
		t.start();
	...
	public void setUI() {
		...
		sendB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// 이 함수는 send 버튼을 누르는 순간 작동하는 함수이다.
				// 할일 
				// 1. 입력내용 알아내고
